...
#funzioni che definiscono i filtri
...
#analizza se esiste un contenuto di frequenza 
# specifico nell'immagine in direzioni specifiche 
# in una regione localizzata attorno al punto o 
# alla regione di analisi.
...
# il metodo di convoluzione per convolvere due 
# filtri sul roi per ottenere due immagini filtrate
