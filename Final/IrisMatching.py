...
#prevede la classe di un campione di prova utilizzando il classificatore del centro più vicino 
# e le distanze tra questo campione e ogni dato di addestramento.
...
#classifica i dati utilizzando caratteristiche ridotte
...
#calcolare fmr e fnmr per disegnare la curva ROC in futuro
